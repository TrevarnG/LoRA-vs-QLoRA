...
from transformers import AutoTokenizer, RobertaForQuestionAnswering, TrainingArguments, Trainer, DataCollatorWithPadding
import numpy as np
import torch

dataset = load_dataset("rajpurkar/squad_v2")
RobertaModel = RobertaForQuestionAnswering.from_pretrained("roberta-large")
